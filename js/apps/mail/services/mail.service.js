        ...
        mails = [{
            ...
            },
            {
                ...
                body: 'Hey, Muki. \n' +
                    ...
                    'Payment methods used (total)\n MasterCard x - #### ₪ 46.90 ILS. \nPaypal.',
                isRead: false,
                sentAt: 1629977371705 - 10000 * 60 * 60 * 20,
                to: 'Muki@appsus.com',
                from: 'service@paypal.co.il',
                isTrash: false,
                isStarred: false,
            ...
            {
                id: utilService.makeId(),
                subject: 'עדכון בפרוייקט גמר',
                body: 'היי מוקי, תעשה פוש לפרוייקט, צריך להגיש מחר!',
                isRead: true,
                sentAt: 1629977371705 - 10000 * 60 * 60 * 60 * 20,
                to: 'Muki@appsus.com',
                from: 'Yoti@appsus.com',
                nickname: 'Yotam',
                isTrash: false,
                isStarred: true,
                isDraft: false,
            ...
            }, ,
            {
                ...
                body: 'היי מוקי,\n' +
                    'קיבלת ציון 100 על הפרוייקט האחרון. כל הכבוד!',
                isRead: true,
                sentAt: Date.now(),
                to: 'Muki@appsus.com',
                from: 'alon-dai@coding-academy.com',
                nickname: 'Alon Dai-Coding Academy',
                isTrash: false,
                isStarred: true,
                isDraft: false,
                color: utilService.getRandomColor()
